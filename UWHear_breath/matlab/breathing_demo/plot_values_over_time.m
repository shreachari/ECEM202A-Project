...
% *************** add back for breath
    current_values = 1e3 * current_values;
%     current_values = smooth(current_values, 256);
...
%     figure()
%     plot(current_values, "linewidth", 5)
%     xlabel("Time/s")
%     ylabel("Normalized Frequency")
    fig = figure("Position",[10 10 1800 450]);
    ax1 = subplot(1,3,[1 2 3]);
...
%     video = VideoReader("IMG_5004.MOV");
    ...
    % Load writing video
    video_write = VideoWriter('breathing_dummy2.avi');
